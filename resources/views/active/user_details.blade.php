            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item">Details {{ $user->name }} for {{ $program->name }}
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="{{ $ROOT_URL.'/store/'.$user->avatar }}" onerror="this.onerror=null;this.src='/images/inspace-logo.png'" alt="User Avatar" width="100%">
                        </div>
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <small class="m-0">Institution</small>
                                    <p class="mb-2">{{ $user->institution }}</p>

                                    <small class="m-0">Class/Major</small>
                                    <p class="mb-2">{{ $user->class_major }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <form action="{{ route('active.program.accept_payment.user',[
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <a href="{{ route('active.program.download_files.user', [
                                            'program' => $program->slug,
                                            'user' => $user->id
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="card h-100">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <small class="m-0">{{ $user->name }}</small>
