...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('programs.store') }}" method="post" id="form" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-12">
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea name="description" id="description" class="form-control"
                                            rows="4" placeholder="Masukkan Deskripsi Lengkap..."></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control"
                                            id="wa_link" name="wa_link" placeholder="Wa Link">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-control" id="comittee_id"
                                            ...
                                            @foreach ($comittees as $comittee)
                                                <option value="{{ $comittee->id }}"
                                                    {{ old('comittee_id') == $comittee->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="number" class="form-control"
                                            id="price" name="price" placeholder="Masukan Biaya Pendaftaran...">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-check radio">
                                            <label for="individual"><input class="form-check-input" name="group_settings"
                                                type="radio" id="individual" value="0"> Individual</label><br>
                                            <label for="group"><input class="form-check-input" name="group_settings"
                                                type="radio" id="group" value="1"> Group</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-check radio">
                                            <label for="competition" onclick="javascript:showEmbed(false)"><input class="form-check-input" name="category"
                                                type="radio" id="competition" value="Competition"> Competition</label><br>
                                            <label for="tournament" onclick="javascript:showEmbed(true)"><input class="form-check-input" name="category"
                                                type="radio" id="tournament" value="Tournament"> Tournament</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12" id="embed-form" style="display:none">
                                    <div class="form-group mb-4">
                                        <label for="embed_link">Embed Link</label>
                                        <input type="text" class="form-control"
                                            id="embed_link" name="embed_link"
                                            placeholder="Https://xxxxxxxx.com/embed/xxxxx">
                                    </div>
                                </div>
                                <div class="col-12" id="limit-form" style="display:none">
                                    <div class="form-group mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" class="form-control required-field" id="label" name="label" placeholder="Ex: Stage 1">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group mb-4">
                                                        <label>Keterangan</label>
                                                        <input type="text" class="form-control required-field" name="keterangan" placeholder="Ex: Open Registration">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    <label>Label</label>
                                                    <input type="text" class="form-control" name="file_label" placeholder="Ex: Proposal">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-4">
                                                    <label>Description</label>
                                                    <textarea name="file_desc" class="form-control file-desc" placeholder="description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="datetime-local"
                                                class="form-control"
                                                id="start_payment" name="start_payment">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
