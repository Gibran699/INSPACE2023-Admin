    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url({{ asset('src/assets/images/big/3.jpg') }});">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Enter your email address and password to access comittee panel.</p>
                        <form class="mt-4" method="post" action="{{ route('comittee.login.post') }}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 text-center mt-5"><a href="#" class="text-danger">Forgot Password</a>
                                </div>
                            </div>
                        </form>
                    </div>
