                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('faq.store') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="question" class="form-control rounded-0 @error('title') is-invalid @enderror" id="title" placeholder="Masukkan Pertanyaan..." value="{{ old('title') }}">
                            @error('title')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="answer" class="form-control rounded-0 @error('short_description') is-invalid @enderror" placeholder="Masukkan jawaban..." id="short_description" cols="30" rows="10">{{ old('short_description') }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="font" class="form-control rounded-0 @error('font') is-invalid @enderror" id="font" placeholder="cth: fa fa-mortar-board" value="{{ old('font') }}">
